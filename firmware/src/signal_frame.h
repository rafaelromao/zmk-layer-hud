...
/* The layers frame is the widest at four bytes. Kept at eight so a kind added later has
 * room without every host needing a new buffer. */
#define ZLS_FRAME_MAX_PAYLOAD 8
