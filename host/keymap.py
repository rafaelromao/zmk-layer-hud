...
HUD_DEFAULTS = {
    ...
    "press_ms": 320,           # how long a key stays lit after a press when no release is reported (no positions)
    "release_ms": 60,          # how long a key stays lit after its reported release
